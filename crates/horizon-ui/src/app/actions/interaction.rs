...
mod tests {
    ...
    use super::{
        ...
        effective_scroll_modifiers, next_middle_pan_active, pending_capture_event, primary_selection_routing_active,
        space_scroll_pan_active, swallow_cancel_escape_event, swallow_captured_clipboard_event,
        swallow_correlated_shift_text, swallow_held_speech_hotkey_event, swallow_speech_hotkey_event,
        tab_scroll_pan_active, wheel_pan_scroll_input,
    };
