...
impl PanelContent {
    ...
    pub fn terminal(&self) -> Option<&Terminal> {
        match self {
            ...
            Self::Editor(_) | Self::GitChanges(_) | Self::FileExplorer(_) | Self::Usage(_) => None,
        }
    }
    ...
    pub fn editor(&self) -> Option<&MarkdownEditor> {
        match self {
            ...
            Self::Terminal(_) | Self::GitChanges(_) | Self::FileExplorer(_) | Self::Usage(_) => None,
        }
    }
    ...
    pub fn git_changes(&self) -> Option<&DiffViewer> {
        match self {
            ...
            Self::Terminal(_) | Self::Editor(_) | Self::FileExplorer(_) | Self::Usage(_) => None,
        }
    }
    ...
    pub fn usage(&self) -> Option<&UsageDashboard> {
        match self {
            Self::Usage(u) => Some(u),
            Self::Terminal(_) | Self::Editor(_) | Self::GitChanges(_) | Self::FileExplorer(_) => None,
        }
    }
